...
//   - ctx context.Context
//   - hash string
func (_e *MockAPIKeyRepository_Expecter) GetByKeyHash(ctx interface{}, hash interface{}) *MockAPIKeyRepository_GetByKeyHash_Call {
	return &MockAPIKeyRepository_GetByKeyHash_Call{Call: _e.mock.On("GetByKeyHash", ctx, hash)}
}

func (_c *MockAPIKeyRepository_GetByKeyHash_Call) Run(run func(ctx context.Context, hash string)) *MockAPIKeyRepository_GetByKeyHash_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
